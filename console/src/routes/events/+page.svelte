<script lang="ts">
	...
	const sourceHelperText =
		'<strong>Recent source events:</strong> Generated by apps, tasks, schedules and they trigger pipeline runs';

	const allHelperText =
		'<strong>All recent events:</strong> Includes source events + other events that occur when a pipeline runs';
</script>
