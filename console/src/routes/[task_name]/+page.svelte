		...
		{#if taskRan}
			<div class="flex space-x-4 place-items-start">
				...
				<p class="font-medium dark:text-white text-grey">
					...
					<br /><br />
					Overall Summary: During the past three months, the TechXplorers team has been actively working
					on various projects, contributing to both feature development and maintenance tasks. The team's
					collaboration and dedication have resulted in significant progress and improvements in our
					codebase.
					<br /><br />
					Total Pull Requests (PRs) Created: 45

					<br /><br />

					Project Highlights: 1. Project: "InnovateHub" PRs Created: 15 Description: InnovateHub is
					our flagship project aimed at revolutionizing the way teams collaborate on innovative
					ideas. The team has been actively working on
				</p>
			</div>
		{/if}
	</div>
